                ...
                mAuth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            if (fUser != null) {
                                User user = new User(); Log.d("test", "createUserWithEmail:onComplete:" + task.isSuccessful());
                                ...
                                user.setGroceries(1000);
                                user.setInvoice(2000);
                                user.setTransportation(5000);
                                user.setShopping(5000);
                                user.setRent(10000);
                                user.setTrips(6000);
                                user.setUtilities(2000);
                                user.setOther(2500);
